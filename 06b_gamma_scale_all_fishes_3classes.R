...
##  code: Shane Blowes
##==============================================================================================================
# code to do gamma-scale analysis for all fishes and three protection classes (supplementary material)
...
gamma_boot_results$alt_enforcement <- factor(gamma_boot_results$alt_enforcement,
...
cowplot::plot_grid(gamma_S_PIE_all, gamma_Sn_all, gamma_S_all, nrow = 1)
# plot all beta-scale results
cowplot::plot_grid(beta_S_PIE_all, beta_Sn_all, beta_S_all, nrow = 1)

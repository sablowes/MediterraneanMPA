...
# want to get temperature and productivity data for each location
...
# get the rugosity from the orginal data
rug <- mpa3_reduced %>% 
...
# PERMANOVA for asking whether there are systematic differences
